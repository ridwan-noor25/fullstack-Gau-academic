...
//     const existingRole =
//       (ctxUser?.role || ctxRole || localStorage.getItem("role") || "").toLowerCase();
//     if (existingRole) nav(roleToPath(existingRole), { replace: true });
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, []);
...
//         {/* Header */}
//         <div className="mb-6 text-center">
//           <h2 className="mt-2 text-2xl md:text-3xl font-extrabold text-green-900">Login</h2>
//           <p className="text-sm text-gray-600 mt-1">Access your dashboard securely.</p>
//         </div>
...
//           <div className="border-t bg-gray-50 px-6 md:px-8 py-4">
//             <div className="flex items-center justify-center">
//               <p className="text-sm text-gray-700">
//                 Forgot your password?{" "}
//                 <Link
//                   to="/forgot-password"
//                   className="font-medium text-green-700 hover:text-green-800 hover:underline underline-offset-4"
//                 >
//                   Reset it here
//                 </Link>
//                 .
...
//               {/* Password + inline 'Forgot password?' */}
//               <div>
//                 <label className="block text-sm font-medium text-gray-700">Password</label>
//                 <div className="relative mt-1">
//                   <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
...
//                 {/* 🔗 Forgot password — placed BEFORE the Login button */}
//                 <div className="mt-2 flex justify-end">
//                   <Link
//                     to="/forgot-password"
//                     className="text-sm font-medium text-green-700 hover:text-green-800 hover:underline underline-offset-4"
//                   >
//                     Forgot password?
//                   </Link>
//                 </div>
...
export default function LoginPage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const redirectPath = roleToPath(resolvedRole);
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <input
                    ...
                    placeholder="you@example.com"
                    autoComplete="email"
                    className="block w-full rounded-md border border-gray-300 bg-white p-2.5 pl-3 shadow-sm transition focus:border-green-600 focus:ring-green-600"
                  />
                </div>
              </div>

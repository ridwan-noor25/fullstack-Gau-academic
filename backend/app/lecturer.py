...
#     Grade,
#     TeachingAssignment,       # use TA instead of Unit.lecturer_id
#     MissingMarkReport,        # correct class name in your models
# )
...
#     # JOIN: MissingMarkReport -> User (student) -> Unit
#     rows = (
#         db.session.query(
...
#             # columns your table shows
#             "student": r.student_name or "",
#             "reg_number": r.reg_number or "",
#             "unit": unit_label,
#             "message": msg,

#             # extra data (useful for actions)
...
#     def map_row(r):
#         # name fallbacks (use email prefix if name missing)
...
#             # --- Student name (multiple aliases)
#             "student": name,
#             "student_name": name,
#             "name": name,

#             # --- Registration number (multiple aliases)
#             "reg_number": reg_val,
#             "regNo": reg_val,
#             "reg_no": reg_val,
...
def unit_students(unit_id: int):
    ...
    rows = (
        ...
        .order_by(User.name.asc())  # simple ordering (compatible with SQLite)
        .all()
    )

    def map_row(r):
        # fallback so UI never shows blank names
        name = (r.student_name or "").strip()
        ...
        # Return both a nested student object and flat aliases to satisfy different UIs
        return {
            "id": r.enroll_id,
            "student_id": r.student_id,
